        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTimeLog = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTimeLog = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StartPoint = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByIp = table.Column<string>(type: "nvarchar(390)", maxLength: 390, nullable: false),
                    Revoked = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    RevokedByIp = table.Column<string>(type: "nvarchar(390)", maxLength: 390, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Role", "admin", 1L });
